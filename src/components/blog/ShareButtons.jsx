...
export default function ShareButtons({ title, url }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-mono uppercase tracking-widest text-g500">Share</span>
      <a
        href={`https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedTitle}`}
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 border border-g200 text-ink hover:bg-ink hover:text-paper transition-colors"
